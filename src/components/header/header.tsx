...
export function Header() {
  return (
    <>
      <header className="w-full absolute top-0 left-0 right-0 z-51 duration-300 bg-background/80 backdrop-blur-xs border-b border-border">
        <div className="h-20 mx-auto max-w-[1250px] px-4 sm:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button size={ButtonSize.sm} variant={ButtonVariant.secondary} onClick={() => { }}>
